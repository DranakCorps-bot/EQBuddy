...
|---|---|---|--:|
| [`docs/plans/DRA-373.md`](docs/plans/DRA-373.md) | DRA-373 | 2026-09-24 ~12:15 PM CT - Evolved landing page LAUNCH STREAMLINING (Founder card): ten sections cut to five, deep dive relocated to `docs/HOW-EQBUDDY-WORKS.md`, Roadmap removed, Download CTA kept pre-tag-truthful with a declared release-day flip (D2 rider). Gate: C4 fired - Challenger waked 2026-09-24, keyed line lands in the plan header on return; LIVE ASK after that | 11,326 B |
