...
| The gap since the previous level-up is HOVER text only — never a third token on the row, and never an age that ticks | **Auto** — `LevelHistoryTests`, `WidgetRenderTests` |
