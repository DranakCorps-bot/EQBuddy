# BEVEL.md - archived entries (2026-Q3)

Rotated out of the live `BEVEL.md` on 2026-09-20 by DRA-258 (DRA-144 F9), verbatim and
byte-for-byte. Two blocks, in their original order:

1. The 20 dated `###` pre-designs (2026-08-16 .. 2026-09-05) that sat under the live
   file's undated container heading `## Things worth knowing before reviewing this
   codebase`. That container heading is still live; only its dated children moved.
2. The nine `##` Helm-signed review entries (2026-08-16 .. 2026-08-23) that followed it.

Nothing here was reflowed, re-dated or edited. The live file keeps the 12 newest `##`
entries (back to 2026-09-13), the 2026-09-08 STANDING LOCK, and both entries cited by
the test suite.
...
## 2026-09-20 — ROTATION PASS APPENDED (DRA-266; entries dated before 2026-09-08)

Everything BELOW this line was moved out of the active `BEVEL.md` by
