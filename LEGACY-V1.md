...
**It has not been cut yet.** The current public 1.x release is [**v1.99.17**](https://github.com/DranakCorps-bot/EQBuddy/releases/tag/v1.99.17) and the links below point at it. When the bridge release is published, this section and those links move to the bridge tag, and this paragraph says which tag it is instead of saying it is pending. Progress is tracked on [issue #275](https://github.com/DranakCorps-bot/EQBuddy/issues/275).
